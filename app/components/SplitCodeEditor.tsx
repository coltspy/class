...
export default function SplitCodeEditor({
  ...
  const [visualizerKey, setVisualizerKey] = useState(0) // For forcing iframe refresh
  ...
  const refreshVisualizer = () => {
    setVisualizerKey(prev => prev + 1) // Forces iframe to reload with new code
  }
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl overflow-hidden border border-gray-200 bg-white shadow-sm">
        <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
          <span className="font-medium text-gray-700">Code Visualizer</span>
        </div>
        <div className="h-[500px]">
          <iframe 
            ...
            frameBorder="0" 
            src={`https://pythontutor.com/iframe-embed.html#code=${encodeURIComponent(code)}&codeDivHeight=400&codeDivWidth=350&cumulative=false&curInstr=0&heapPrimitives=nevernest&origin=opt-frontend.js&py=js&rawInputLstJSON=%5B%5D&textReferences=false`}
          />
        </div>
      </div>
    </div>
